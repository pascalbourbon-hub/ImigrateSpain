...
const lawyers = [
  ...
  },
  {
    ...
    roleEN: "Nationality & Family Reunification Lawyer",
    roleES: "Abogada de Nacionalidad y Reagrupación Familiar",
    bioEN: "Cristina specialises in Spanish nationality procedures and family reunification cases. Fluent in Italian, she is the go-to expert for Italy's growing expat community in Spain and for Latin American clients pursuing the Ibero-American nationality route.",
    bioES: "Cristina está especializada en procedimientos de nacionalidad española y reagrupación familiar. Con dominio del italiano, es la experta de referencia para la creciente comunidad de expatriados italianos en España y para clientes latinoamericanos que siguen la vía iberoamericana.",
    specialtyEN: "Nationality & Family Reunification",
    specialtyES: "Nacionalidad y Reagrupación Familiar",
